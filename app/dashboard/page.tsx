...
export const metadata: Metadata = {
  ...
  description: "Panel de control para la gestión del equipo",
}
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Torneos Próximos</CardTitle>
                <Trophy className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">3</div>
                <p className="text-xs text-muted-foreground">Próximo en 15 días</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Torneos programados para los próximos 3 meses</CardDescription>
              </CardHeader>
              <CardContent>
                <UpcomingTournaments />
              </CardContent>
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Últimas actualizaciones y actividades</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentActivity />
              </CardContent>
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Genera y descarga informes personalizados</CardDescription>
            </CardHeader>
            <CardContent>
